<form action="/comments" class="comment-form" method="post">
    ...
    <div class="form-group">
        <textarea class="form-control comment-content" rows="3" name="content" placeholder="Ajouter une reponse..."></textarea>
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-primary">Ajouter une reponse</button>
    </div>
</form>